...
import { checkIfFollows, findTweetsByUser, findUserBySlug, follow, getUserFollowCount, getUserFollowersCount, getUserTweetCount, unfollow, updateUserInfo } from "../services/user";
...
export const getUser = async (req: ExtendedRequest, res: Response)  => {
    ...
    const followingCount = await getUserFollowCount(user.slug);
