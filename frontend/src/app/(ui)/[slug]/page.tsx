                ...
                <div className='px-6 mt-4'>
                    ...
                    {user.link && 
                      <div className='flex gap-2 items-center'>
                        ...
                        <Link href={user.link} target="_blank" className='text-blue-400'>{user.link}</Link>
                      </div>
                    }
                    <div className="my-5 flex gap-6">
                        <div className='text-xl text-gray-500'><span className='text-white'> 99</span> Seguindo</div>
                        <div className='text-xl text-gray-500'><span className='text-white'> 1000</span> Seguidores</div>
                    </div>
                </div>
            </section>
            <ProfileFeed />
